   <!-- Footer -->
    <footer class="bg-dark text-white mt-5">
        <div class="newsletter container">
            <div class="row">
                <div class="col-md-6">
                    <h5><i class="fas fa-envelope me-2"></i>Đăng Ký Nhận Tin</h5>
                    <p>Nhận ưu đãi mới nhất!</p>
                </div>
                <div class="col-md-6">
                    <form class="d-flex">
                        <input class="form-control me-2" type="email" placeholder="Email của bạn">
                        <button class="btn btn-success" type="submit"><i class="fas fa-paper-plane"></i> Gửi</button>
                    </form>
                </div>
            </div>
        </div>
        <div class="container py-4">
            ...
            <hr>
            <p class="text-center">&copy; 2025 Tạp hoá của Quang. All rights reserved.</p>
        </div>
    </footer>
